...
(async () => {
  ...
  await fs.writeFile("diabetic-ophthalmic-complications-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("diabetic-ophthalmic-complications-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
